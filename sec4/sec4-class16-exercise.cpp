...
void initMap() {
	...
	people.insert(make_pair(3, Person("Vicky", 30, "Scottish")));
	people.insert(make_pair(4, Person("Vicky", 30, "Scottish")));
}
...
void addUser(int userId, string* data) {
	...
	people.insert(make_pair(userId, Person(datos[0], atoi(datos[1].c_str()), datos[2])));
}
